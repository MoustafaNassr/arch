                    ...
                    <div className="col-lg-6 col-md-7">
                        <div className="about_text_inner">
                            <div className="about_text">
                                <SubHeading title="ABOUT 238Creative ARCHITECTS"></SubHeading>
                                <Paragraph text="238Creative Architects is a full-service design firm providing architecture, master planning, urban design, interior architecture, space planning and programming. Our portfolio of completed work includes highly acclaimed and award-winning projects for clients."></Paragraph>
                            </div>
