                ...
                <div className="section-header text-center has_line">
                    ...
                    <div className="section-desc row align-items-center justify-content-center">
                        <div className="col-lg-6 text-end">
                            <Paragraph text="We will continue to grow and evolve 238Creative for the betterment of our clients and our people. Vision includes the continual expansion." />
                        </div>
