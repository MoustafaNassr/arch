        ...
        <div className="project-details_inner">
            <div className="post_content">
                ...
                <div className="fulltext">
                    <p>
                        238Creative Architects is a full-service design firm providing architecture, master planning, urban design, interior architecture, space planning and programming. Our portfolio of completed work includes highly acclaimed and award-winning projects for clients around the country.
                    </p>
                    ...
                    <ul className="point_order">
                        <li>The talent at 238Creative runs wide and deep. Across many markets, geographies & typologies.</li>
