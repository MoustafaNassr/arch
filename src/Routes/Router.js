...
import HomeLayout01 from "../Layouts/HomeLayout01";
...
export const routes = createBrowserRouter([
    ...
    },
    {
        ...
        children: [
            ...
            //     loader: ({ params }) => fetch(`https://238Creative-server.vercel.app/products/${params.id}`)
            // },
            // {
            //     path: '/shop-category/:id',
            //     element: <ShopCategory/>,
            //     loader: ({ params }) => fetch(`https://238Creative-server.vercel.app/products/category/${params.id}`),
            // },
